...
SkoliodoiMercenary::SkoliodoiMercenary()
{
}
...
void SkoliodoiMercenary::FirstDay(Character* Hero)
{
	int choice;
	bool ok;
	Wait(2);

	cout << "Zajdar:\tHi, I'm Zajdar. I see you are a warrior, would you like o join us? I organize an expedition inside this forest and this is my team.\n";
	Wait(2);
	...
	Wait(2);
	cout << Hero->GetName() << ":\It sounds interesting. I'm not in a hurry, so I can spend with you a few days.\n";
	Wait(2);
	...
	cout << endl;
	Wait(4);
	cout << "STORY:\tAccidently you see a lizard with a tail of a scorpion and it is attacking you.\n";
...
void SkoliodoiMercenary::SecondDay(Character* Hero)
{
	int choice;
	Wait(2);
	cout << "STORY:\tIn the morning you go further. You are deep in the forest. It's time to choose the last way to the heart of the forest. First douloses go to reconnoitre. They come back and you may watch then and choose where to go.\n";
	Wait(2);
	cout << "CHOOSE THE WAY. DESCRIPTION OF EVERY DOULOS IS BELOW\n";
	cout << "1) His hands turned into branches.\n2) He shoots lightning\n3) He lost his voice and blows smoke\n4) he has 2 additional hands\n5) His skin turned into slimy rock\n";
	choice = Read(5);
	switch (choice)
	{
	case 1:
